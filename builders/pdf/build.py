"""Build script for generating story.tex from template."""
...
def get_template() -> Template:
    ...
    return env.get_template("story.tex.template")
...
def render_tex(template: Template, data: Dict[str, str]) -> None:
    """Inject data into template and create the tex file."""
    file = Path("build") / "story.tex"
